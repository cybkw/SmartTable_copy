...
import com.dev.smart.form.component.IComponent;
...
import com.dev.smart.form.data.column.ColumnInfo;
import com.dev.smart.form.data.format.IFormat;
import com.dev.smart.form.data.format.bg.BaseBackgroundFormat;
import com.dev.smart.form.data.format.bg.BaseCellBackgroundFormat;
import com.dev.smart.form.data.format.bg.ICellBackgroundFormat;
import com.dev.smart.form.data.format.count.ICountFormat;
import com.dev.smart.form.data.format.draw.BitmapDrawFormat;
import com.dev.smart.form.data.format.draw.ImageResDrawFormat;
import com.dev.smart.form.data.format.draw.MultiLineDrawFormat;
import com.dev.smart.form.data.format.draw.TextImageDrawFormat;
import com.dev.smart.form.data.format.grid.BaseAbstractGridFormat;
import com.dev.smart.form.data.format.grid.BaseGridFormat;
import com.dev.smart.form.data.format.tip.MultiLineBubbleTip;
import com.dev.smart.form.data.format.title.TitleImageDrawFormat;
import com.dev.smart.form.data.style.FontStyle;
import com.dev.smart.form.data.table.TableData;
import com.dev.smart.form.listener.OnColumnClickListener;
import com.dev.smart.form.listener.OnColumnItemClickListener;
import com.dev.smart.table.bean.ChildData;
import com.dev.smart.table.bean.TableStyle;
import com.dev.smart.table.bean.TanBean;
import com.dev.smart.table.bean.UserInfo;
import com.dev.smart.table.view.BaseCheckDialog;
import com.dev.smart.table.view.BaseDialog;
import com.dev.smart.table.view.QuickChartDialog;
import com.dev.smartchat.component.axis.BaseAxis;
import com.dev.smartchat.component.base.IAxis;
import com.dev.smartchat.core.LineChart;
import com.dev.smartchat.data.ChartData;
import com.dev.smartchat.data.LineData;
import com.dev.smartchat.data.style.PointStyle;
import com.dev.smartchat.provider.component.cross.VerticalCross;
import com.dev.smartchat.provider.component.level.LevelLine;
import com.dev.smartchat.provider.component.mark.BubbleMarkView;
import com.dev.smartchat.provider.component.point.Point;
...
public class GridModeActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private void showChartDialog(String tableName,List<String> chartYDataList,List<Integer> list ){
       ...
       FontStyle.setDefaultTextSpSize(this,12);
        ...
        //设置标题样式
        com.dev.smartchat.data.style.FontStyle fontStyle = lineChart.getChartTitle().getFontStyle();
