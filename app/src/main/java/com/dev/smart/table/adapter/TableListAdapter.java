...
import com.dev.smart.form.utils.DensityUtils;
...
public class TableListAdapter extends BaseQuickAdapter<String, BaseViewHolder> {
    ...
    protected void convert(BaseViewHolder helper, String item) {
        ...
        // ageColumn.setAutoCount(true);
        //table.getConfig().setYSequenceBackgroundColor(getContext().getResources().getColor(R.color.arc1));
        //table.getConfig().setXSequenceBackgroundColor(getContext().getResources().getColor(R.color.arc2));

        //table.getConfig().setContentBackgroundColor(getContext().getResources().getColor(R.color.arc21));
        ...
        ageColumn.setOnColumnItemClickListener(new OnColumnItemClickListener<Integer>() {
            ...
            public void onClick(Column<Integer> column, String value, Integer integer, int position) {
                Toast.makeText(getContext(),"点击了"+value,Toast.LENGTH_SHORT).show();
            }
        });
        FontStyle fontStyle = new FontStyle();
        fontStyle.setTextColor(getContext().getResources().getColor(android.R.color.white));
        MultiLineBubbleTip<Column> tip = new MultiLineBubbleTip<Column>(getContext(),R.mipmap.round_rect,R.mipmap.triangle,fontStyle) {
            @Override
        ...
        table.setOnColumnClickListener(new OnColumnClickListener() {
            ...
            public void onClick(ColumnInfo columnInfo) {
                ...
                Toast.makeText(getContext(),"点击了"+columnInfo.column.getColumnName(),Toast.LENGTH_SHORT).show();
            }
        });
        table.getConfig().setTableTitleStyle(new FontStyle(getContext(),15,getContext().getResources().getColor(R.color.arc1)));
