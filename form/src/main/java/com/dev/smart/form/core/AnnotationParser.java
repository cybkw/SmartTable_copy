    ...
    public PageTableData<T> parse(List<T> dataList){
        if(dataList!= null && dataList.size() >0) {
            ...
            if(firstData != null) {
                ...
                Annotation tableAnnotation = clazz.getAnnotation(com.dev.smart.form.annotation.SmartTable.class);
                if(tableAnnotation != null){
                    com.dev.smart.form.annotation.SmartTable table = (com.dev.smart.form.annotation.SmartTable) tableAnnotation;
